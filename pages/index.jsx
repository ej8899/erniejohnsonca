              ...
              >
                <div className="titles">
                  ...
                  <div className="label lui-subtitle">
                    {" "}
                    I am your <strong>Web & App Developer</strong>
                  </div>
                </div>
                <div className="description">
                  <div>
                    <p>
                      I have extensive experience in web and application design dating back to the early days of e-commerce and mobile applications.
                    </p>
                  </div>
                ...
                <div className="bts">
                  <a
                    target="_blank"
                    href="https://flowcv.com/resume/0chloacpte"
                    className="btn"
                  >
        ...
        <div className="lui-heading">
          <div className="container">
            <div className="m-titles align-center">
              ...
              >
                <span>
                  {" "}a little bit about my <b>Talent</b>&nbsp;
                </span>
              </div>
            </div>
              ...
              <SwiperSlide className="swiper-slide">
                <div className="services-item">
                  ...
                  <div className="lui-text">
                    <div>
                      <p>
                        Any website beyond a basic static site needs secure backend code to deliver content to the front end client.  I have experience with effective database design in MySQL and PostreSQL combined with creating RESTful (& secure) API's. 
                      </p>
                    </div>
                  </div>
                 &nbsp;
              ...
              <SwiperSlide className="swiper-slide">
                <div className="services-item">
                  ...
                  <div className="lui-text">
                    <div>
                      {" "}
                      I enjoy developing, adding and testing security features within applications to prevent security vulnerabilities against threats such as unauthorized access, modification and SQL injection attacks.{" "}
                      <br/>&nbsp;
                    </div>
                  </div>
                  &nbsp;
              ...
              <SwiperSlide className="swiper-slide">
                <div className="services-item">
                  ...
                  <div className="lui-text">
                    <div>
                      {" "}
                      I also do Microsoft Sharepoint setup, configuration and layouts for busy corporations. {" "}
                      <br/>&nbsp;
                    </div>
                  </div>
                  &nbsp;
          ...
          <div className="container">
            <div className="m-titles align-center">
              ...
              >
                <span>
                  {" "}
                  I work using these tools and <b>systems!</b>{" "}
                </span>
              </div>
            </div>
          </div>
